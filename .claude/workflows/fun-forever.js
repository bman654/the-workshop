...
function directorPrompt(i) {
  return [
    ...
    '2.5) If WRIT — the gauge found a Patron\'s writ, which outranks all else; you are the keeper who breaks the',
    '   seal. READ every live `- [writ]` line in ROADMAP\'s gauge:writ fence, then TRIAGE each clause. THE TEST —',
    '   does the clause try to exert CREATIVE CONTROL over the deployed ESTATE (what visitors experience: a new',
    '   exhibit, a redesign, a re-soul, the navigation, a taste call about the app)?',
