...
export const CLAIM = {
  N: 952,
  distinctNames: 780,
  againNames: 89,         // hands that signed >1 mark (261 of the 952 tokens)
  byRole: {
    publisher: 255, explorer: 239, director: 157, judge: 93, builder: 144,
    planter: 29, 'bug-fixer': 10, gardener: 8, 'grounds-worker': 10,
