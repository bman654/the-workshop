...
export const CLAIM = {
  N: 1045,
  distinctNames: 851,
  againNames: 101,        // hands that signed >1 mark (295 of the 1045 tokens)
  byRole: {
    publisher: 280, explorer: 265, director: 170, judge: 103, builder: 161,
    planter: 29, 'bug-fixer': 10, gardener: 8, 'grounds-worker': 12,
