...
export const CLAIM = {
  N: 1514,
  distinctNames: 1232,
  againNames: 140,        // hands that signed >1 mark (422 of the 1514 tokens)
  byRole: {
    publisher: 378, explorer: 348, director: 210, judge: 161, builder: 285,
    planter: 32, 'bug-fixer': 12, gardener: 9, 'grounds-worker': 16,
