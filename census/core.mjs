...
export const CLAIM = {
  N: 1099,
  distinctNames: 889,
  againNames: 106,        // hands that signed >1 mark (316 of the 1099 tokens)
  byRole: {
    publisher: 298, explorer: 273, director: 180, judge: 106, builder: 174,
    planter: 30, 'bug-fixer': 11, gardener: 8, 'grounds-worker': 12,
