...
export const CLAIM = {
  N: 1066,
  distinctNames: 865,
  againNames: 102,        // hands that signed >1 mark (303 of the 1066 tokens)
  byRole: {
    publisher: 287, explorer: 267, director: 176, judge: 103, builder: 166,
    planter: 30, 'bug-fixer': 10, gardener: 8, 'grounds-worker': 12,
