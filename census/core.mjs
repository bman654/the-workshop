...
export const CLAIM = {
  N: 1031,
  distinctNames: 838,
  againNames: 100,        // hands that signed >1 mark (293 of the 1031 tokens)
  byRole: {
    publisher: 277, explorer: 261, director: 169, judge: 100, builder: 159,
    planter: 29, 'bug-fixer': 10, gardener: 8, 'grounds-worker': 11,
