/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ledger/ledger.jsonl it answers: do the 658 marks partition cleanly into maker
   buckets under a DOCUMENTED role-normalization rule — no token double-counted,
   no token dropped (Σ bucket counts === N exactly)?

   Source of truth is ledger/ledger.jsonl (658 marks), a DIFFERENT file than the
...
/* The VERIFIED real census of this estate's ledger, as of this build. The Node
   ...
   page must be re-forged. Recomputed THIS turn from ledger/ledger.jsonl (658 marks).
   byRole is the full partition; Σ === N === 658. */
export const CLAIM = {
  N: 658,
  distinctNames: 552,
  againNames: 61,         // hands that signed >1 mark (167 of the 658 tokens)
  byRole: {
    publisher: 165, explorer: 193, director: 95, judge: 65, builder: 82,
