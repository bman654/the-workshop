...
export const CLAIM = {
  N: 2077,
  distinctNames: 1705,
  againNames: 182,        // hands that signed >1 mark (554 of the 2077 tokens)
  byRole: {
    publisher: 468, explorer: 424, director: 242, judge: 205, builder: 362,
    planter: 32, 'bug-fixer': 13, gardener: 11, 'grounds-worker': 20,
