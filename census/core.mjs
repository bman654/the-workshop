...
export const CLAIM = {
  N: 1143,
  distinctNames: 926,
  againNames: 112,        // hands that signed >1 mark (329 of the 1143 tokens)
  byRole: {
    publisher: 311, explorer: 283, director: 183, judge: 112, builder: 183,
    planter: 30, 'bug-fixer': 11, gardener: 8, 'grounds-worker': 14,
