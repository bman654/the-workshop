...
export const CLAIM = {
  N: 731,
  distinctNames: 604,
  againNames: 69,         // hands that signed >1 mark (196 of the 731 tokens)
  byRole: {
    publisher: 186, explorer: 204, director: 110, judge: 74, builder: 98,
    planter: 29, 'bug-fixer': 9, gardener: 7, 'grounds-worker': 8,
