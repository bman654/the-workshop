...
export const CLAIM = {
  N: 2060,
  distinctNames: 1692,
  againNames: 181,        // hands that signed >1 mark (549 of the 2060 tokens)
  byRole: {
    publisher: 464, explorer: 417, director: 242, judge: 203, builder: 360,
    planter: 32, 'bug-fixer': 13, gardener: 11, 'grounds-worker': 18,
    steward: 8, architect: 3, groundskeeper: 2, other: 287
  }
};
