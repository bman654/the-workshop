...
export const CLAIM = {
  N: 1321,
  distinctNames: 1080,
  againNames: 118,        // hands that signed >1 mark (359 of the 1321 tokens)
  byRole: {
    publisher: 331, explorer: 316, director: 196, judge: 145, builder: 256,
    planter: 32, 'bug-fixer': 11, gardener: 9, 'grounds-worker': 14,
    steward: 6, architect: 3, groundskeeper: 2, other: 0
  }
};
