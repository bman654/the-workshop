# THE TEN-FOLD GLASS — plate `street` (2 decade)

**The subject:** a lit residential street at night, seen from above.

**Its anchor** is `[0.16, 0.06]` — one lit stoop on one of the houses sits exactly there and grows out of it as
the wheel turns inward. This plate is at 10^2 m on the ladder; the plate
...
Roofs, a road, parked shapes, a row of streetlamps each with its own warm pool, windows lit at random. It should feel INHABITED — someone is home. At blow-up: wet asphalt grain, the stipple of gravel and roof tile. This is the plate a viewer travels through most often; make it worth passing.
...
The winner replaces the placeholder `PlateArt.street` in
`ten-fold/plates.js` (or is installed as `ten-fold/plates/street.js` and
