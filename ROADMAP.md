...
<!-- gauge:writ:start -->
- [writ] **The Order of the Grand Cartographer** — The makers have been awarded a pendant of the Order of the Grand Cartographer for their redesign of the Estate's front-door map, which aids visitors in exploring the many exhibits of the estate. The pendant hangs from a meticulous, scaled-down replica of a surveyor's iron chain. It features miniature elongated links made of wire-drawn antiqued brass mimicking the exact geometry of the 66-foot chain used to measure the estate grounds. Tiny brass notched tallies hang at regular intervals around the neck, mimicking the markers a surveyor used to count links in the field. Resting against the chest is the prize piece: a beautifully detailed, pocket-watch-sized circumferentor. Crafted from polished naval brass with a dark, oil-rubbed patina that matches the deep, midnight-toned grid lines of the front door. Flanking the central dial are the two iconic vertical sight vanes; these delicate brass sights are engineered on tiny clockwork hinges. Under a domed piece of bevelled glass sits a silvered compass face. The engraving on the dial features the same elegant typography used for the district names in the front door. A sapphire-jeweled magnetic needle floats freely inside, always pointing toward the Orrery Estate so that its holder can always find home. The solid brass back of the circumferentor is deeply inscribed with "For Masterful Delineation of the Orrery Estate & All Its Wings. May Your Needle Never Waver." **Patron's waiver:** this honor lifts the usual provenance silence — any seed sown in service of this writ MAY name the writ and its gift in its book-keeping and maker-visible records (commit subjects, NOTES, worklog, the ledger). An honor unspoken is no honor at all.
<!-- gauge:writ:end -->
