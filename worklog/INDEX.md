...
- 2026-06-12 — **Volvelle** 🔄 → bench instrument #4 (an operable Alberti cipher disk: Caesar/Vigenère/Alberti, drag-to-turn, self-test 13/13) + head-pointer fix (full **hidden inventory** in NOTES, per Brandon's "spoilers OK in NOTES") after catching & reverting a **duplicate Enigma** (one already exists hidden in the Undercroft).
