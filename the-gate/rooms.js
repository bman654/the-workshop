...
(function (root) {
  ...
  var BESPOKE = {
    ...
    'strange-garden': { rep: 'strange-garden-rep', repColors: { DAY: { 'rep.swatch1': '#8a9690', 'rep.swatch2': '#b89a5e', 'rep.glow1': '#7fd1c7' }, DUSK: { 'rep.swatch1': '#74807c', 'rep.swatch2': '#9a8048', 'rep.glow1': '#7fd1c7' }, NIGHT: { 'rep.swatch1': '#3c4844', 'rep.swatch2': '#5a4a2c', 'rep.glow1': '#9ae8d8' } } },
    'cartographer': { rep: 'cartographer-rep', repColors: { DAY: { 'rep.swatch1': '#caa86a', 'rep.swatch2': '#e6dcc0', 'rep.glow1': '#ffe08a' }, DUSK: { 'rep.swatch1': '#a98a4a', 'rep.swatch2': '#cabf9c', 'rep.glow1': '#ffcf86' }, NIGHT: { 'rep.swatch1': '#6f5d3c', 'rep.swatch2': '#7a7058', 'rep.glow1': '#ffdf9a' } } },
    'arcade': { rep: 'arcade-rep', repColors: { DAY: { 'rep.swatch1': '#3a3550', 'rep.swatch2': '#2b2740', 'rep.swatch3': '#1d1a2e', 'rep.glow1': '#cf7bff', 'rep.glow2': '#e9b8ff' }, DUSK: { 'rep.swatch1': '#352f4d', 'rep.swatch2': '#262238', 'rep.swatch3': '#191628', 'rep.glow1': '#cf7bff', 'rep.glow2': '#eabfff' }, NIGHT: { 'rep.swatch1': '#2e2945', 'rep.swatch2': '#211d33', 'rep.swatch3': '#151221', 'rep.glow1': '#cf7bff', 'rep.glow2': '#f0caff' } } },
    'verse': { rep: 'verse-rep', repColors: { DAY: { 'rep.swatch1': '#8a6a44', 'rep.swatch2': '#e6dcc0', 'rep.glow1': '#ffe0a0' }, DUSK: { 'rep.swatch1': '#74572f', 'rep.swatch2': '#cabf9c', 'rep.glow1': '#ffcf86' }, NIGHT: { 'rep.swatch1': '#4a3a26', 'rep.swatch2': '#7a7058', 'rep.glow1': '#ffdf9a' } } },
    'daedalus': { rep: 'daedalus-rep', repColors: { DAY: { 'rep.swatch1': '#3a7a4a', 'rep.swatch2': '#2c5c3b', 'rep.glow1': '#5fe0c4' }, DUSK: { 'rep.swatch1': '#2f6440', 'rep.swatch2': '#234c33', 'rep.glow1': '#6fead0' }, NIGHT: { 'rep.swatch1': '#1f4230', 'rep.swatch2': '#163425', 'rep.glow1': '#7ff0dc' } } },
    'compositor': { rep: 'compositor-rep', repColors: { DAY: { 'rep.swatch1': '#6a5c4c', 'rep.swatch2': '#8a6f52', 'rep.glow1': '#ffd98a' }, DUSK: { 'rep.swatch1': '#4e4438', 'rep.swatch2': '#6f5a44', 'rep.glow1': '#ffcf7a' }, NIGHT: { 'rep.swatch1': '#322b24', 'rep.swatch2': '#4a3c2e', 'rep.glow1': '#ffbe5c' } } },
    'stellar-forge': { rep: 'stellar-forge-rep', repColors: { DAY: { 'rep.swatch1': '#c9a24a', 'rep.swatch2': '#a3803a', 'rep.swatch3': '#83652c', 'rep.glow1': '#9db4ff', 'rep.glow2': '#dfe6ff' }, DUSK: { 'rep.swatch1': '#ab873f', 'rep.swatch2': '#8a6c32', 'rep.swatch3': '#6b5326', 'rep.glow1': '#a8bcff', 'rep.glow2': '#e4e9ff' }, NIGHT: { 'rep.swatch1': '#7a6540', 'rep.swatch2': '#5c4c30', 'rep.swatch3': '#413622', 'rep.glow1': '#bcccff', 'rep.glow2': '#eef2ff' } } }
  };
