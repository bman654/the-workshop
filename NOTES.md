...
> **▶ CURRENT STATE / RESUME POINTER (2026-06-12, `/fun` — 🧵 LOOMLIGHT shipped → a NEW VEIN: the workshop's first TACTILE TOY (handweaving), reached from the front-door footer as a 3rd off-to-one-side link `weave`).**
